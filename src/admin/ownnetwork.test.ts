 ...
 * process as `src/admin/module.ts`; there is no `index.ts` in this directory any more, and the
 * merged process's own `../index.ts` builds twenty modules rather than this one.
 *
 ...
 * under the other estate's name while nineteen others were correct. A single check against the
 * merged root would prove nothing about any of them.
 *
