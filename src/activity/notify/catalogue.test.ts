 ...
 */
// FOUR levels since wave M5c, not three: this file was `activity/src/notify/…` and is now
// `agora/src/activity/notify/…`. The guard below is what caught the stale depth the moment the
// directory moved, which is the whole reason it exists — a wrong path and a missing sibling
