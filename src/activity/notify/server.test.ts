...
import { NOTIFY_INGEST_PATH, NOTIFY_READ_SCOPE, createServer, type ServerDeps } from './server.ts'
...
const SERVICE: Principal = { kind: 'service', service: 'custody', scopes: [NOTIFY_READ_SCOPE] }
