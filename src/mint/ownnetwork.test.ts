 ...
 * process as `src/mint/module.ts`; there is no `index.ts` in this directory any more, and the
 * merged process's own `../index.ts` builds every module rather than this one.
 *
 ...
 * pod's database under the other estate's name while the other modules were correct. A single check
 * against the merged root would prove nothing about any of them.
 *
