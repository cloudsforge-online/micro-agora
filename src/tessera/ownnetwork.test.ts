 ...
 * process as `src/tessera/module.ts`; there is no `index.ts` in this directory any more, and the
 * merged process's own `../index.ts` builds many modules rather than this one.
 *
