 ...
 * process as `src/market/module.ts`; there is no `index.ts` in this directory any more, and the
 * merged process's own `../index.ts` builds the modules of the platform monolith rather than this
 * one.
 *
