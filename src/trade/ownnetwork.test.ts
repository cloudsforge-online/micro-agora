 ...
 *
 * Read against the source rather than the runtime: booting a composition root opens a database and
 * a job runner, and the defect is visible in the text.
 */
 ...
 * process as `src/trade/module.ts`; there is no `index.ts` in this directory any more, and the
 * merged process's own `../index.ts` builds eighteen modules rather than this one.
 *
 ...
 * pod's database under the other estate's name while seventeen others were correct. A single check
