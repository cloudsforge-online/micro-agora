 ...
 * process as `src/community/module.ts`; there is no `index.ts` in this directory any more, and the
 ...
 * pod's database under the other estate's name while the other modules were correct. A single
