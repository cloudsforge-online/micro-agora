...
const server = createMergedServer(
  ...
  // 200 to a deletion that left every brand kit, prompt and generated image standing, every
  // custodial stake still naming the person who placed it, and — since the owner settled the rule
  // on 2026-09-02 — every wallet, deposit address, credit and withdrawal still naming its owner
  // (micro-org#534).
  inbound: [studio.inbound, foresight.inbound, wallet.inbound],
  pageSizeMax: env.pageSizeMax,
